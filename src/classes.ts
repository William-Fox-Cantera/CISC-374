...
class BankAccount {
    ...
    */
    withdraw(amount_requested: number): number {
        let amount_returned: number = amount_requested;
 ...
 */
const acc1 = new BankAccount("StickyKeysAccount");
const acc2 = new BankAccount("RandomAccount");
const acc3 = new BankAccount("WilliamAccount");
 ...
 */
const ship1 = new SpaceShip("Megalodon");
const ship2 = new SpaceShip("Big Cola");
const ship3 = new SpaceShip("Fire Distinguisher");
...
let isFriends1: boolean = ship2.makeFriend(ship3);
let isFriends2: boolean = ship1.makeFriend(ship3);
